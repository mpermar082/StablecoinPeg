// src/lib.rs
/*
 * Core library for StablecoinPeg
 */
...
#[derive(Debug)]
pub struct StablecoinPegProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StablecoinPegProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StablecoinPeg processing");
    
    let mut processor = StablecoinPegProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StablecoinPegProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StablecoinPegProcessor::new(false);
